...
class LunarLander_HighestFPS(LunarLander):
    r"""
    ## Description
    ...
    * The angular velocity is in units of 0.4 radians per second. In order to convert to radians per second, the value needs to be multiplied by a factor of 2.5.
    ...
    def __init__(
        ...
        self.obs_seq_len = 1
        self.single_obs_dim = 8 # original obs
    ...
    def reset(
        ...
        *,
        ...
        # Add observation to the buffer, this will be used to return the initial observation
...
register(
    id="LunarLander_HighestFPS",
    entry_point="envs.lunar_lander_highest_fps:LunarLander_HighestFPS",
