...
import argparse
import envs.lunar_lander_var_fps_kf as lunar_lander_var_fps_kf
import re
...
RUN_SEED        = 42
MAX_EVAL_WORKERS = 16
NAV_MODEL_PATH = "runs/LunarLander_GaussianWind__train__windTrue_20.0_2.0_vert20.0__1__1785251869/model.pt"
...
def evaluate_model_single_run(model, nav_model, frame_cost, budget, fixed, wind_cfg):
    env = gym.make("LunarLander_VarFramerate_KF", frame_cost=frame_cost, budget=budget, **wind_cfg)
