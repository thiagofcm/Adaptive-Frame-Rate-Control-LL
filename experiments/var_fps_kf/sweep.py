#!/usr/bin/env python3
"""Sweep runner for experiments/lunar_lander_var_fps_kf/train.py (LunarLander_VarFramerate_KF).

Reads a sweep config (default: config/sweep_lunar_lander_kf.yaml) containing every base
hyperparameter (including the wind/Kalman-filter params enable_wind, wind_power,
...
DEFAULT_SWEEP_CONFIG = os.path.join(REPO_ROOT, "config", "sweep_lunar_lander_kf.yaml")
# train.py subprocesses run with this as cwd -- matches config/sweep_lunar_lander_kf.yaml's
